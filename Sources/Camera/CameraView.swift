...
class CameraView: UIView, UIGestureRecognizerDelegate {
  ...
  func makeFlashButton() -> TripleButton {
    let states: [TripleButton.TripleButtonState] = [
      TripleButton.TripleButtonState(title: "Gallery.Camera.Flash.Off".g_localize(fallback: Config.Text.flashButtonOffText), image: GalleryBundle.image("gallery_camera_flash_off")!),
      TripleButton.TripleButtonState(title: "Gallery.Camera.Flash.On".g_localize(fallback: Config.Text.flashButtonOnText), image: GalleryBundle.image("gallery_camera_flash_on")!),
